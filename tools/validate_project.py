...
def main(
    ...
    check_init(word2vec_mt.path)

    check_docstrings_dir(os.path.abspath(os.path.join(word2vec_mt.path, '..', '..', 'tools')))
    check_docstrings_dir(os.path.abspath(os.path.join(word2vec_mt.path, '..', '..', 'bin')))
    check_docstrings_dir(word2vec_mt.path)
